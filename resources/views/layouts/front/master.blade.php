        ...
        <div class="row no-gutters">
            <div class="col-md-6 col-xs-12 col-lg-4">
                <div class="featured-slider mr-md-3 mr-lg-3">
                    <div class="item" style="background-image:url({{asset('asset/front/images/news/img-1.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-6 col-xs-12 col-lg-4">
                 <div class="featured-slider mr-lg-3">
                    <div class="item" style="background-image:url({{asset('asset/front/images/news/img-2.jpg')}})">
                        <div class="post-content">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12 col-lg-4">
                <div class="row mt-3 mt-lg-0">
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('asset/front/images/news/news-02.jpg')}})">
                            <div class="post-content">
                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-6 col-md-6">
                        <div class="post-featured-style" style="background-image:url({{asset('asset/front/images/news/news-04.jpg')}})">
                            <div class="post-content">
